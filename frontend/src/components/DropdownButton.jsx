...
function DropdownButton({ isDropdownOpen, toggleDropdown }) {
  return (
    <div className="relative">
      ...
      >
        <span className="font-medium text-gray-900 text-xs md:text-sm">Last 24 hours</span>
        <img
          src={arrowIcon}
          alt="arrow"
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-2 w-34 md:w-36 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
          <button
            className={`block w-full text-left px-4 py-2 text-xs md:text-sm hover:bg-gray-100 hover:rounded-t-lg cursor-pointer`}
          >
            Last 24 hours
          </button>
          ...
          <button
            className={`block w-full text-left px-4 py-2 text-xs md:text-sm hover:bg-gray-100 hover:rounded-b-lg cursor-pointer`}
          >
            Last 3 months
          </button>
        </div>
